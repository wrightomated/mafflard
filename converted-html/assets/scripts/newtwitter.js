if (!window.__twttrlr) {
    (function (a, b) {
        ...
        function D() {
            for (var a in d)
                if (d[a].readyState == "interactive") return l[d[a].id]
        }
        ...
        y.prototype.then = function (b) {
            ...
            if (!this.completed) {
                ...
                if (this.callbacks)
                    for (var b = 0, c; c = this.callbacks[b]; b++) c.apply(a, this.results)
            }
...
__twttrlr(function (using, provide, loadrunner, define) {
    provide("util/util", function (a) {
        function b(a) {
            ...
            for (; c = arguments[b]; b++)
                for (d in c)
                    if (!c.hasOwnProperty || c.hasOwnProperty(d)) a[d] = c[d];
            return a
        }

        function c(a) {
            for (var b in a) a.hasOwnProperty(b) && (k(a[b]) && (c(a[b]), l(a[b]) && delete a[b]), (a[b] === undefined || a[b] === null || a[b] === "") && delete a[b]);
            return a
        }
        ...
        using("util/util", function (b) {
            ...
            var c = {
                ...
                trigger: function (a, b) {
                    ...
                    b.type = a;
                    if (c)
                        for (var d = 0, e; e = c[d]; d++) e.call(this, b)
                }
            };
        ...
        using("util/querystring", "util/util", "util/twitter", function (b, c, d) {
            ...
            function f() {
                var a = document.getElementsByTagName("link"),
                    ...
                    c;
                for (; c = a[b]; b++)
                    if (c.rel == "canonical") return e(c.href)
            }
    ...
    provide("util/iframe", function (a) {
        a(function (a) {
            ...
            if (a.attributes)
                for (e in a.attributes) a.attributes.hasOwnProperty(e) && c.setAttribute(e, a.attributes[e]);
        ...
        using("util/util", "util/domready", "dom/get", "util/querystring", "util/iframe", "util/typevalidator", function (b, c, d, e, f, g) {
            ...
            b.aug(m.prototype, {
                ...
                create: function (a, b, c) {
                    return c["data-twttr-rendered"] = !0, f({
                        url: a,
                        css: b,
    ...
    provide("tfw/widget/intent", function (a) {
        using("tfw/widget/base", "util/util", "util/querystring", "util/uri", function (b, c, d, e) {
            ...
            var f = /twitter\.com(\:\d{2,4})?\/intent\/(\w+)/,
                ...
                k = screen.width,
                l;
            s.prototype = new b, c.aug(s.prototype, {
                render: function (a) {
        ...
        using("util/util", function (b) {
            a({
                sanitize: function (a, c, d) {
                    ...
                    for (; f && (h = f[g]); g++) h[0].match(c) && h[1].match(e) && i.push(h.join(":") + j);
                    return i.join(";")
                }
            })
        })
    ...
    provide("dom/sandbox", function (a) {
        using("util/domready", "util/env", function (b, c) {
            ...
            window.twttr || (window.twttr = {}), window.twttr.sandbox || (window.twttr.sandbox = {}), f.prototype.getCallback = function (a) {
                ...
                if (!c.anyIE() || c.cspEnabledIE()) return;
        ...
        using("dom/cookie", "dom/sandbox", "util/donottrack", "tfw/util/guest_cookie", "tfw/util/env", "util/util", "$xd/json2.js", function (b, c, d, e, f, g) {
            ...
            function x(a, b, c) {
                ...
                f = g.aug({}, b, {
                    ...
                    l: I(f)
                }), G(i)) : (d = l.firstChild, d.value = +d.value || +f.dnt, h = I(f), e = q.createElement("input"), e.type = "hidden", e.name = "l", e.value = h, l.appendChild(e))
            }
            ...
            function E() {
                ...
                return k++, a.action = s, a.method = "POST", a.target = "rufous-frame-" + k, a.id = "rufous-form-" + k, b.type = "hidden", b.name = "dnt", b.value = 0, a.appendChild(b), a
            }
            ...
            var h = "twttr_",
                ...
                }, j = ["hask", "li", "logged_in", "pid", "user_id", e.guest_id_cookie, h + "hask", h + "li", h + e.guest_id_cookie],
                k = 0,
                l, m, n = [],
                o, p, q, r, s = "https://twitter.com/i/jot";
            e.forceNewCookie(), a({
                enqueue: y,
                flush: z,
                initPostLogging: t,
        ...
        using("util/logger", "util/util", "util/querystring", function (b, c, d) {
            ...
            function p(a, b, c) {
                ...
                return function (g) {
                    ...
                    h = c(g), e[h] = g;
                    if (++f === d) {
                        for (l = 0; l < d; l++) m = e[a[l]], i.push(m), m.error ? k.push(m) : j.push(m);
            ...
            twttr.widgets && twttr.widgets.endpoints && c.aug(k, twttr.widgets.endpoints), j.jsonp = function (a, b, c) {
                ...
                var b, c = {}, e, f, g;
                arguments.length === 1 ? (b = a.ids, c = o(a)) : (b = a, c.success = arguments[1]), e = l("array", b) ? k.userLookup : k.userShow, b = l("array", b) ? b.join(",") : b, f = {
                    user_id: b
                ...
                c.compact(i), f = d.url(k.timeline + a.id, i), this.jsonp(f, e, "tl_" + a.id + "_" + a.instanceId)
                ...
                c.compact(f), g = d.url(k.timelinePoll + a.id, f), this.jsonp(g, e, "tlPoll_" + a.id + "_" + a.instanceId + "_" + (a.sinceId || a.maxId))
        ...
        using("util/util", function (b) {
            ...
            function n(a) {
                ...
                this.timeAgo = function (a) {
                    var b = n.parseDate(a),
                        ...
                        g = f - b,
                        m;
                    return b ? isNaN(g) || g < h * 2 ? e("now") : g < i ? (m = Math.floor(g / h), e(d.abbr, {
                        number: m,
                        symbol: e(l, {
                            abbr: e("s"),
                            expanded: m > 1 ? e("seconds") : e("second")
                        })
                    })) : g < j ? (m = Math.floor(g / i), e(d.abbr, {
                        number: m,
                        symbol: e(l, {
                            abbr: e("m"),
                            expanded: m > 1 ? e("minutes") : e("minute")
                        })
                    })) : g < k ? (m = Math.floor(g / j), e(d.abbr, {
                        number: m,
                        symbol: e(l, {
                            abbr: e("h"),
                            expanded: m > 1 ? e("hours") : e("hour")
                        })
                    })) : g < k * 365 ? e(d.shortdate, {
                        day: b.getDate(),
            ...
            n.parseDate = function (a) {
                ...
                return i = function () {
                    ...
                    if (a = h.match(d)) return Date.UTC(a[7], b.indexOf(f, a[1]), a[2], a[3], a[4], a[5]);
    ...
    provide("tfw/util/assets", function (a) {
        using("util/env", function (b) {
            ...
            var c = {
                "embed/timeline.css": {
                    "default": "embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.default.css",
                    "2x": "embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.2x.css",
                    gif: "embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.gif.css",
                    "default.rtl": "embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.default.rtl.css",
                    "2x.rtl": "embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.2x.rtl.css",
                    "gif.rtl": "embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.gif.rtl.css"
                }
            };
            a(d)
        })
    ...
    provide("tfw/widget/syndicatedbase", function (a) {
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "dom/classname", "dom/delegate", "dom/sandbox", "util/env", "util/twitter", "util/util", function (b, c, d, e, f, g, h, i, j, k) {
            ...
            var l = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:focus", ".customisable:active", ".customisable-highlight:hover", ".customisable-highlight:focus", "a:hover .customisable-highlight", "a:focus .customisable-highlight"],
                m = ["a:hover .ic-mask", "a:focus .ic-mask"],
                n = [".customisable-border"],
                o = [".timeline-header h1.summary", ".timeline-header h1.summary a:link", ".timeline-header h1.summary a:visited"],
                p, q, r;
            v.prototype = new b, k.aug(v.prototype, {
                setupSandbox: function (a) {
                    var b = a.doc,
                        c = b.createElement("base"),
                        d = b.createElement("style"),
                        f = b.getElementsByTagName("head")[0],
                        g = "body{display:none; font-family:Arial,Tahoma,san-serif !important;} .tweet{border-top: 1px solid #eee !important; font-family:Arial,Tahoma,san-serif !important;} .timeline-footer{background: rgba(0,0,0,0) !important; padding:10px 0 0 !important;}",
                        h = this,
                        i;
                    ...
                    for (; i = this.sandboxReadyCallbacks.shift();) i.fn.apply(i.context, i.args)
                },
                ...
                callIfSandboxReady: function (a, b, c) {
                    c = c || [], b.frameIsReady ? a.apply(b, [!1].concat(c)) : b.sandboxReadyCallbacks.push({
                        fn: a,
                        context: b,
                        args: [!0].concat(c)
                    })
                ...
                contentWidth: function () {
                    var a = this.dimensions,
                        b = this.chromeless && this.narrow ? a.NARROW_MEDIA_PADDING_CL : this.chromeless ? a.WIDE_MEDIA_PADDING_CL : this.narrow ? a.NARROW_MEDIA_PADDING : a.WIDE_MEDIA_PADDING;
                    return this.width - b
                },
                addSiteStyles: function () {
                    ...
                    if (e.val("widgets:csp") == "on") return;
                    if (b.getElementById(c)) return;
                    this.headingStyle && g.push(k.map(o, f).join(",") + "{" + this.headingStyle + "}"), this.linkColor && (g.push(k.map(l, f).join(",") + "{color:" + this.linkColor + "}"), g.push(k.map(m, f).join(",") + "{background-color:" + this.linkColor + "}")), this.borderColor && g.push(k.map(n, f).concat(this.theme == "dark" ? [".thm-dark.customisable-border"] : []).join(",") + "{border-color:" + this.borderColor + "}");
                    if (!g.length) return;
                    d = b.createElement("style"), d.id = c, d.type = "text/css", d.styleSheet ? d.styleSheet.cssText = g.join("") : d.appendChild(b.createTextNode(g.join(""))), b.getElementsByTagName("head")[0].appendChild(d)
                },
                ...
                return b > a && b > d ? (a *= d / b, b = d) : a > c && (b *= c / a, a = c, b > d && (a *= d / b, b = d)), {
                    width: Math.ceil(a),
                    height: Math.ceil(b)
                }
                ...
                for (; e = [c, d][i]; i++)
                    if (e.length)
                        for (j = 0; f = e[j]; j++) g = v.scaleDimensions(f.getAttribute("width") || f.width, f.getAttribute("height") || f.height, b, 375), g.width > 0 && (f.width = g.width), g.height > 0 && (f.height = g.height), h = g.height > h ? g.height : h;
                return h
            }, s(), a(v)
        })
    });
    provide("tfw/widget/timeline", function (a) {
        using("tfw/widget/syndicatedbase", "util/datetime", "anim/transition", "tfw/util/data", "tfw/util/tracking", "tfw/util/params", "util/css", "util/env", "util/iframe", "util/insert", "util/throttle", "util/twitter", "util/querystring", "util/typevalidator", "util/util", "dom/delegate", "dom/classname", "dom/get", function (b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            function M(a) {
                if (!a) return;
                var c, d, e, f, g, i, j;
                this.a11yTitle = this._("Twitter Timeline Widget"), b.apply(this, [a]), c = this.params(), d = (c.chrome || this.dataAttr("chrome") || "").split(" "), this.preview = c.previewParams, this.widgetId = c.widgetId || this.dataAttr("widget-id"), this.instanceId = ++L, (f = c.screenName || this.dataAttr("screen-name")) || (g = c.userId || this.dataAttr("user-id")) ? this.override = {
                    overrideType: "user",
                    overrideId: g,
                    overrideName: f,
                    withReplies: o.asBoolean(c.showReplies || this.dataAttr("show-replies")) ? "true" : "false"
                } : (f = c.favoritesScreenName || this.dataAttr("favorites-screen-name")) || (g = c.favoritesUserId || this.dataAttr("favorites-user-id")) ? this.override = {
                    overrideType: "favorites",
                    overrideId: g,
                    overrideName: f
                } : ((f = c.listOwnerScreenName || this.dataAttr("list-owner-screen-name")) || (g = c.listOwnerId || this.dataAttr("list-owner-id"))) && ((i = c.listId || this.dataAttr("list-id")) || (j = c.listSlug || this.dataAttr("list-slug"))) ? this.override = {
                    overrideType: "list",
                    overrideOwnerId: g,
                    overrideOwnerName: f,
                    overrideId: i,
                    overrideName: j
                } : this.override = {}, this.tweetLimit = o.asInt(c.tweetLimit || this.dataAttr("tweet-limit")), this.staticTimeline = this.tweetLimit > 0, d.length && (e = ~p.indexOf(d, "none"), this.chromeless = e || ~p.indexOf(d, "transparent"), this.headerless = e || ~p.indexOf(d, "noheader"), this.footerless = e || ~p.indexOf(d, "nofooter"), this.borderless = e || ~p.indexOf(d, "noborders"), this.noscrollbar = ~p.indexOf(d, "noscrollbar")), this.headingStyle = h.sanitize(c.headingStyle || this.dataAttr("heading-style"), undefined, !0), this.classAttr.push("twitter-timeline-rendered"), this.ariaPolite = c.ariaPolite || this.dataAttr("aria-polite")
            }
            ...
            var t = "1.0",
                ...
                K = "show-new-tweet",
                L = 0;
            M.prototype = new b, p.aug(M.prototype, {
                ...
                create: function (a) {
                    ...
                    }, !0, this.dnt), f.flush(), this.ariaPolite == "assertive" && (h = s.one(w, d, "DIV"), h.setAttribute("aria-polite", "assertive")), d.id = this.id, d.className += " " + this.classAttr.join(" "), d.lang = this.lang, twttr.widgets.load(d), i = function () {
                ...
                render: function (a, b) {
                    ...
                    function i() {
                        f.initPostLogging(), e.timeline(p.aug({
                            id: c.widgetId,
                ...
                getTweetDetails: function (a) {
                    ...
                    for (; d = b[i]; i++) e = s.one(F, d, "A"), f = m.status(e.href), g = d.getAttribute("data-tweet-id"), f === g ? c[f] = {
                        item_type: h.TWEET
                    } : c[f] = {
                        item_type: h.RETWEET,
                        target_type: h.TWEET,
                    ...
                    h[c ? "sinceId" : "maxId"] = a, h.complete = function () {
                        ...
                        if (a && a.body !== undefined) {
                            ...
                            i.length && (f.enqueue({
                                ...
                                event_initiator: c ? u.CLIENT_SIDE_APP : u.CLIENT_SIDE_USER
                            }, !0, g.dnt), f.flush()), b.retinize(h), b.constrainMedia(h, g.contentWidth());
                ...
                augmentWidgets: function (a) {
                    var b = s.all(G, a, "A"),
                        c = 0,
                        d;
                    for (; d = b[c]; c++) d.setAttribute("data-related", this.related), d.setAttribute("data-partner", this.partner), d.setAttribute("data-dnt", this.dnt), d.setAttribute("data-search-query", this.searchQuery), d.setAttribute("data-profile-id", this.profileId), this.width < 250 && d.setAttribute("data-show-screen-name", "false")
                },
    ...
    provide("tfw/widget/embed", function (a) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "tfw/util/params", "dom/classname", "dom/get", "util/env", "util/util", "util/throttle", "util/twitter", "tfw/util/data", "tfw/util/tracking", function (b, c, d, e, f, g, h, i, j, k, l, m) {
            ...
            function t(a) {
                ...
                if ((b.align || this.attr("align")) == "left" || ~i.indexOf(this.classAttr, "tw-align-left")) this.align = "left";
                else if ((b.align || this.attr("align")) == "right" || ~i.indexOf(this.classAttr, "tw-align-right")) this.align = "right";
                else if ((b.align || this.attr("align")) == "center" || ~i.indexOf(this.classAttr, "tw-align-center")) this.align = "center", this.containerWidth > this.dimensions.MIN_WIDTH * (1 / .7) && this.width > this.containerWidth * .7 && (this.width = this.containerWidth * .7);
            ...
            var n = "2.0",
                o = "tweetembed",
                p = {};
            t.prototype = new c, i.aug(t.prototype, {
                ...
                render: function (a, b) {
                    ...
                    this.hideCard && (d += "c"), this.hideThread && (d += "t"), d && (e += "-" + d), h = this.callsWhenSandboxReady(function (a) {
                        ...
                        var b;
                        if ((!window.getComputedStyle || c.sandbox.win.getComputedStyle(c.sandbox.body, null).display !== "none") && c.element.offsetHeight) return d();
                ...
                augmentWidgets: function (a) {
                    var b = g.all("twitter-follow-button", a, "A"),
                        c, d = 0;
                    for (; c = b[d]; d++) c.setAttribute("data-related", this.related), c.setAttribute("data-partner", this.partner), c.setAttribute("data-dnt", this.dnt), c.setAttribute("data-show-screen-name", "false")
                },
                addUrlParams: function (a) {
                    var b = this,
                        c = {
                ...
                handleResize: function () {
                    this.handleResize = j(function () {
                        var a = this,
                            b = Math.min(this.dimensions.DEFAULT_WIDTH, Math.max(this.dimensions.MIN_WIDTH, this.sandbox.frame.offsetWidth));
                        if (!this.element) return;
                ...
                if (a.keys) b = a.keys();
                    ...
                    for (c in a) a.hasOwnProperty(c) && b.push(c); if (!b.length) return;
                m.initPostLogging(), d = a[b[0]][0].lang, l.tweets({
                    ids: b.sort(),
                    lang: d,
                    complete: function (b) {
                        var c, d, e, f, g, h, i = [];
                        for (c in b)
                            if (b.hasOwnProperty(c)) {
                                g = a[c] && a[c];
                                for (e = 0; g.length && (f = g[e]); e++) f.s && (f.s.call(this, b[c]), f.r && i.push(f.r));
                                delete a[c]
                            }
                        ...
                        for (d in a)
                            if (a.hasOwnProperty(d)) {
                                g = a[d];
                                for (e = 0; g.length && (f = g[e]); e++) f.f && f.f.call(this, b[c])
                            }
                        m.flush()
                    }
                })
    ...
    provide("tfw/widget/tweetbase", function (a) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/twitter", "util/uri", function (b, c, d, e, f) {
            ...
            i.prototype = new c, b.aug(i.prototype, {
                parameters: function () {
                    var a = {
                        text: this.text,
                        url: this.url,
        ...
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function (b, c, d, e, f, g) {
            var h = document.title,
                ...
                k = function (a) {
                    ...
                    if (d.type == "hashtag" || ~c.indexOf(this.classAttr, "twitter-hashtag-button")) this.type = "hashtag";
                    else if (d.type == "mention" || ~c.indexOf(this.classAttr, "twitter-mention-button")) this.type = "mention";
            ...
            k.prototype = new b, c.aug(k.prototype, {
                parameters: function () {
                    var a = {
                        text: this.text,
                        url: this.url,
                ...
                width: function () {
                    var a = {
                        ...
                        d = this.type == "hashtag" && this.button_hashtag ? "Tweet %{hashtag}" : this.type == "mention" && this.screen_name ? "Tweet to %{name}" : "Tweet",
                        e = this._(d, {
                ...
                render: function (a, b) {
                    var c = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1371247185.html#" + this.parameters();
                    this.count && this.classAttr.push("twitter-count-" + this.count), this.element = this.create(c, this.dimensions(), {
    ...
    provide("tfw/widget/follow", function (a) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function (b, c, d, e, f, g) {
            ...
            h.prototype = new c, b.aug(h.prototype, {
                parameters: function () {
                    var a = {
                ...
                render: function (a, b) {
                    ...
                    var c = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1371247185.html#" + this.parameters();
        ...
        twttr.events = {
            ...
            c(function () {
                using("tfw/widget/base", "tfw/widget/follow", "tfw/widget/tweetbutton", "tfw/widget/embed", "tfw/widget/timeline", "tfw/widget/intent", "tfw/util/globals", "util/events", "util/util", function (c, d, e, f, g, h, i, j, k) {
                    ...
                    i.init(), n.assetUrl = q, twttr.widgets = twttr.widgets || {}, k.aug(twttr.widgets, {
                        config: {
                            assetUrl: q
                        },
                        load: function (a) {
                        ...
                        createTweet: function (a, b, c, d) {
                            ...
                            d = k.aug({}, d || {}, {
                                tweetId: a,
                                targetEl: b
                            }), (new f(d)).render(n, c), f.fetchAndRender()
                        },
